      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-400 via-primary to-cyan-400 bg-clip-text text-transparent">
              Fatur.
            </h2>

            <p className="mt-5 max-w-xs text-sm leading-7 text-gray-400 text-center md:text-left">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-x-8 gap-y-4">
              {links.map((item) => (
                <Link
                  key={item.name}
                  to={item.to}
                  className="relative text-gray-300 transition duration-300 hover:text-primary after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-primary after:transition-all after:duration-300 hover:after:w-full"
                >
                  {item.name}
                </Link>
              ))}
